...
> Статус: дизайн одобрен 2026-09-15. PR 1 (данные) слит как #35; PR 2–5 переписаны под общие ящики и выполнены как PR 8a–8d серии `2026-09-15-shared-mailboxes-google-login-design.md`; инструкция для администратора — `docs/operations/google-oauth.md`. Доменный почтовый сервер перенесён в PR 9 той же серии.

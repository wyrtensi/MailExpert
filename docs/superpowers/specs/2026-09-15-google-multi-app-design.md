...
> Статус: дизайн согласован 2026-09-15, реализация не начата.
...
- Для Gmail одна кнопка: пользователь вводит email, а приложение выбирает MailExpert.
...
**Frontend (`node --test`):** утилиты формы Gmail и выбора варианта, `reconnectUrlFor`, `parseOAuthResult` для новых кодов, отображение состояний приложений, покрытие ключей i18n во всех локалях.
